...
export default class FoxgloveServer {
  ...
  public readonly supportedEncodings?: string[];
   ...
   */
  public handleProtocols(protocols: Iterable<string>): string | false {
   ...
   */
  public addChannel(channel: Omit<Channel, "id">): ChannelId {
   ...
   */
  public addService(service: Omit<Service, "id">): ServiceId {
   ...
   */
  public removeService(serviceId: ServiceId): void {
   ...
   */
  public sendMessage(chanId: ChannelId, timestamp: bigint, payload: BufferSource): void {
    for (const client of this.#clients.values()) {
   ...
   */
  public broadcastTime(timestamp: bigint): void {
   ...
   */
  public sendServiceCallResponse(response: ServiceCallPayload, connection: IWebSocket): void {
   ...
   * @param connection Connection of the client that called the service
   */
  public sendServiceCallFailure(response: ServiceCallFailure, connection: IWebSocket): void {
   ...
   * @param parameters Parameter values
   */
  public updateParameterValues(parameters: Parameter[]): void {
   ...
   */
  public handleConnection(connection: IWebSocket, name: string): void {
   ...
   * @param connection Connection of the client that called the service
   */
  public sendFetchAssetResponse(response: FetchAssetResponse, connection: IWebSocket): void {
   ...
   */
  public sendStatus(status: Omit<StatusMessage, "op">, connection?: IWebSocket): void {
    if (connection) {
   ...
   */
  public removeStatus(statusIds: string[], connection?: IWebSocket): void {
    if (connection) {
