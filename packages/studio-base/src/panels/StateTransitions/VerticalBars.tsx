...
import type { Scale } from "./StateTransitionsChartRenderer";
import type { StateTransitionsCoordinator } from "./StateTransitionsCoordinator";

type Props = {
  coordinator?: StateTransitionsCoordinator;
...
export const VerticalBars = React.memo(function VerticalBars({
  ...
  useEffect(() => {
    ...
    return unsubscribe;
  }, [messagePipelineSubscribe, updateBars]);
