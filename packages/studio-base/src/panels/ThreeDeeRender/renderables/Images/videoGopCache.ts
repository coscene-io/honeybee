...
/** Floor for a cache's share, so a many-camera layout still holds a useful GOP window. */
export const MIN_VIDEO_GOP_CACHE_MAX_BYTES = 16 * 1024 * 1024;
