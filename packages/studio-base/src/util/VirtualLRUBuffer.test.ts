...
describe("VirtualLRUBuffer", () => {
  ...
  describe("#copyFrom", () => {
    it("lets you copy a buffer into a single block", () => {
      ...
      vb.copyFrom(Uint8Array.from(new Array(25).fill(0)), 0);
      vb.copyFrom(Uint8Array.from([1, 2, 3, 4]), 2);
      vb.copyFrom(Uint8Array.from([5, 6, 7, 8]), 12);
    ...
    it("lets you copy a buffer spread over two blocks", () => {
      const vb = new VirtualLRUBuffer({ size: 25, blockSize: 10 });
      vb.copyFrom(Uint8Array.from(new Array(25).fill(0)), 0);
      vb.copyFrom(Uint8Array.from([1, 2, 3, 4]), 8);
      vb.copyFrom(Uint8Array.from([5, 6, 7, 8]), 18);
      //                <--------- block 1 -------->  <--------- block 2 -------->  <-- block 3 ->
    ...
    it("lets you copy a buffer spread over three blocks", () => {
      const vb = new VirtualLRUBuffer({ size: 25, blockSize: 10 });
      vb.copyFrom(Uint8Array.from(new Array(25).fill(0)), 0);
      vb.copyFrom(Uint8Array.from([1, 2, 3, 4, 5, 6, 7, 8, 9, 1, 2, 3, 4, 5]), 8);
      //                <--------- block 1 -------->  <--------- block 2 -------->  <-- block 3 ->
