...
export type CoSceneDataSourceFactoryInitializeArgs = {
...
export interface CoSceneIDataSourceFactory {
  id: string;
  type: DataSourceFactoryType;
  displayName: string;
  iconName?: RegisteredIconNames;
  ...
  // Initialize a player.
  initialize: (args: CoSceneDataSourceFactoryInitializeArgs) => Player | undefined;
}
...
export interface CoScenePlayerSelection {
  selectSource: (sourceId: string, args?: DataSourceArgs) => void;
  selectRecent: (recentId: string) => void;

  /** Currently selected data source */
  selectedSource?: CoSceneIDataSourceFactory;

  /** List of available data sources */
  availableSources: CoSceneIDataSourceFactory[];
...
export const CoScenePlayerSelectionContext = createContext<CoScenePlayerSelection>({
  selectSource: () => {},
  selectRecent: () => {},
  availableSources: [],
  recentSources: [],
});
CoScenePlayerSelectionContext.displayName = "CoScenePlayerSelectionContext";

export function useCoScenePlayerSelection(): CoScenePlayerSelection {
