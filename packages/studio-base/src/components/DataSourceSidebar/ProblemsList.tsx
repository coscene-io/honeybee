...
export function ProblemsList({ problems,setProblemModal}: { problems: PlayerProblem[],   setProblemModal?: (_: JSX.Element | undefined) => void;
}): JSX.Element {
          ...
          <ListItem disablePadding key={`${idx}`}>
            <ListItemButton onClick={() => showProblemModal(problem)}>
              <Stack direction="row" gap={0.5} alignItems="center">
                ...
                <ListItemText primary={getErrorMessage(problem.message)}/>
              </Stack>
            </ListItemButton>
          </ListItem>
        ))}
