...
export const error: Partial<TypeOptions["resources"]["error"]> = {
  ...
  panelUnexpectedError: "此面板遇到意外错误",
  appUnexpectedError: "应用遇到意外错误",
  somethingWentWrongPanel:
    "此面板出现问题。<dismissLink>关闭此错误</dismissLink> 以继续使用该面板。如果问题仍然存在，请尝试重置面板。",
  somethingWentWrongApp:
    "出现问题。<dismissLink>关闭此错误</dismissLink> 以继续使用应用。如果问题仍然存在，请尝试重启应用。",
  resetPanel: "重置面板",
  removePanel: "移除面板",
  resetPanelSettingsToDefault: "将面板设置重置为默认值",
  removePanelFromLayout: "从布局中移除此面板",
  errorStack: "错误堆栈：",
  componentStack: "组件堆栈：",
  showDetails: "显示详情",
  hideDetails: "隐藏详情",
  missingShareManifestArgument: "缺少分享清单参数",
