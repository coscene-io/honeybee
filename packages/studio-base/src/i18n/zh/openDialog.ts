...
export const openDialog: Partial<TypeOptions["resources"]["openDialog"]> = {
  ...
  login: "登录",
  udpPort: "UDP 端口",
  launchCoSceneStudio: "启动 coScene Studio",
  web: "网页",
  requiresChrome: "需要 Chrome v76+",
  desktopApp: "桌面应用",
  forLinuxWindowsMacos: "适用于 Linux、Windows 和 macOS",
  rememberMyPreference: "记住我的选择",
  launchingCoSceneStudio: "正在启动 coScene Studio…",
  directedToDesktopApp: "已跳转到桌面应用。",
  openThisLinkInBrowser: "在浏览器中打开此链接",
  youCanAlsoOpenInBrowser: "你也可以<link>在浏览器中打开此链接</link>。",
  dontHaveAppInstalled: "还没有安装应用？",
  downloadCoSceneStudio: "下载 coScene Studio",
};
