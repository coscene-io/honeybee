...
export const openDialog = {
  ...
  login: "Login",
  udpPort: "UDP Port",
  launchCoSceneStudio: "Launch coScene Studio",
  web: "Web",
  requiresChrome: "Requires Chrome v76+",
  desktopApp: "Desktop App",
  forLinuxWindowsMacos: "For Linux, Windows, and macOS",
  rememberMyPreference: "Remember my preference",
  launchingCoSceneStudio: "Launching coScene Studio…",
  directedToDesktopApp: "We’ve directed you to the desktop app.",
  openThisLinkInBrowser: "open this link in your browser",
  youCanAlsoOpenInBrowser: "You can also <link>open this link in your browser</link>.",
  dontHaveAppInstalled: "Don’t have the app installed?",
  downloadCoSceneStudio: "Download coScene Studio",
};
