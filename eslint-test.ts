...
class Foo {
  private bar = 1; // eslint-disable-line @coscene-io/prefer-hash-private
  private static baz = 1; // eslint-disable-line @coscene-io/prefer-hash-private
  // eslint-disable-next-line @coscene-io/prefer-hash-private
  private foo() {
    this.bar = 2;
  }
  // eslint-disable-next-line @coscene-io/prefer-hash-private
